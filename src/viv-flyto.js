...
import { flyToViewport, getFlyToDuration } from './flyto-utils';
 ...
 */
export default class FlyToInterpolatorViv extends TransitionInterpolator {
  /**
   * @param props {Object}
  ...
  constructor(props = {}) {
    super({
      compare: ['target', 'zoom', 'bearing', 'pitch'],
      extract: ['width', 'height', 'target', 'zoom', 'bearing', 'pitch'],
